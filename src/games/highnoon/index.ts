...
const COLORS = { brass: '#d9a441', cream: '#f4e6c4', blood: '#b3262c', ink: '#2b1a0e', sage: '#8fae5a' };
...
const cowboyModel = (outfit: number) => Models.gltf(COWBOYS[outfit % COWBOYS.length].url, { rig: 'humanoid', poses: STYLE, firstPerson: { scale: 0.9 } });
